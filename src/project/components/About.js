...
function About() {
  return (
    <div>
      <marquee direction="left" width='100%' height='30px'>Welcome to High-Q Labs web page. This page is created by using React Router Dom. Designed by Chandu.</marquee>
      ...
      <div className='hometext'>
        ...
        <dl>
          <dt className='dt'><span id='homespan'>Services </span></dt>
          <dd className='dd'>
